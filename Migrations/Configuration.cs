    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DahaimMVC.Models.UserDbContext>
    {
        ...
        protected override void Seed(DahaimMVC.Models.UserDbContext context)
        {
            context.User.AddOrUpdate(x => x.UserId,
                new User() { UserId = 1, Name = "Mietek", UserName = "muser", ConfirmPassword = "mpass1", UserPassword = "mpass1", Email = "mietek@gmail.com", LanguageLvl = LanguageLvlEmun.B2, Subname = "Zorro", PhoneNumber = "123123123" },
                ...
                new User() { UserId = 12, Name = "Genowefa", UserName = "Genowefa", ConfirmPassword = "Genowefa1", UserPassword = "Genowefa1", Email = "Genowefa@gmail.com", LanguageLvl = LanguageLvlEmun.B2, Subname = "Apple", PhoneNumber = "890890890" }
                );
        }
    }
}